     ...
     <div className='AboutMe'>
        <div className='me-container'>
          <div className='me-texts'>
            ...
            <p>I am a new graduated as a Software Engineer from Bahcesehir University. At start, I was learning software for developing games, but later I find out my passion was on web development. So I learned about web development.</p>
            <p>You can learn more about me through my socials, you can find my github page and my resume below here.</p>
          </div>
          <div className='me-buttons'>
            ...
            <a href="https://github.com/Galledan" target="_blank" rel="noopener noreferrer"><div className="me-button github"><i class="fab fa-github"></i></div></a>
